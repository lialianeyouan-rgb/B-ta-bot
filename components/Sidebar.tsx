  ...
  return (
    <div className="w-64 bg-gray-800 p-4 flex flex-col space-y-4 border-r border-gray-700">
      ...
      <nav className="flex flex-col space-y-2">
        ...
        <NavItem icon={<BacktestingIcon />} label="Backtesting" isActive={currentView === 'backtesting'} onClick={() => setCurrentView('backtesting')} />
      ...
      <div className="mt-auto p-2 text-center text-xs text-gray-500">
        <p>Gemini Arbitrage Engine v2.0</p>
        <p>&copy; 2024</p>
      </div>
    </div>
  );
